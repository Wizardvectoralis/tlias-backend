...
//       log.info("传入的参数有：{},{},{}",username,age,image);
   ...
   // }
    ...
    //以下方法调用AliOSSUtils工具类实现文件上传到阿里云并返回该图片地址
    @PostMapping("/upload")
    public String uploadImg(String name,Integer age, MultipartFile image) throws Exception {

        String objectname = aliOSSUtils.upload(image);
        return objectname;
    }
